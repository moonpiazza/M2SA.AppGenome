...
sc create "MemCachedStats#M2SA.AppGenome.ServiceHost" binpath= "%cd%\M2SA.AppGenome.ServiceHost.exe -service" displayname= "MemCachedStats#M2SA.AppGenome.ServiceHost" depend= Tcpip start= auto
