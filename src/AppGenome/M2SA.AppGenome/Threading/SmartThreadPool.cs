...
using M2SA.AppGenome.Threading.Internal;
...
namespace M2SA.AppGenome.Threading
{
	...
	/// </summary>
	public sealed partial class SmartThreadPool : WorkItemsGroupBase, IDisposable
	{
        ...
        public void Dispose()
        {
            if (!_isDisposed)
            {
                ...
                if (null != this._localPCs)
                {
                    this._localPCs.Close();
                }
