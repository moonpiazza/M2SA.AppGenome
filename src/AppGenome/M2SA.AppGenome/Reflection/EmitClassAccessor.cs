...
{
    internal class EmitClassAccessor : IClassAccessor
    {
        ...
        public EmitClassAccessor(Type targetType)
        {
            ...
            for (var i = 0; i < instanceProperties.Length; i++)
            {
                ...
                var accessor = new EmitPropertyAccessor(this.m_TargetType, propertyName);
